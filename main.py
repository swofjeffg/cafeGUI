...
class App:
    def __init__(self, root):
        ...
        self.menu_state = states.Menu_State(self.state_frame, self.unique_categories, self.menu, self.images, self.small_images, [self.state_picker, self.update_order])
    ...
    def update_order(self, item, added):
        if added:
            for entry in self.menu:
                if item == entry['name']:
